...
si47x_response_status currentStatus;
    ...
    void SI4735_sendProperty(uint16_t propertyNumber, uint16_t param);
    ...
    //void SI4735_getStatus();
    void SI4735_getStatus1(uint8_t, uint8_t);
     ...
     */
    inline bool SI4735_getSignalQualityInterrupt()
    {
     ...
     * @return RDSINT status
     */
    inline bool SI4735_getRadioDataSystemInterrupt()
    {
     ...
     */
    inline bool SI4735_getTuneCompleteTriggered()
    {
     ...
     * @return Error flag
     */
    inline bool SI4735_getStatusError()
    {
     ...
     * @return CTS
     */
    inline bool SI4735_getStatusCTS() { return currentStatus.resp.CTS; };
     ...
     * @return true
     */
    inline bool SI4735_getACFIndicator()
    {
     ...
     * @return BLTF
     */
    inline bool SI4735_getBandLimit()
    {
     ...
     * @return false
     */
    inline bool SI4735_getStatusValid()
    {
     ...
     * @return uint8_t
     */
    inline uint8_t SI4735_getReceivedSignalStrengthIndicator()
    {
     ...
     * @return uint8_t
     */
    inline uint8_t SI4735_getStatusMULT()
    {
     ...
     */
    inline uint16_t SI4735_getAntennaTuningCapacitor()
    {
     ...
     *
     */
    inline void SI4735_setAvcAmMaxGain0()
    {
    	SI4735_sendProperty(AM_AUTOMATIC_VOLUME_CONTROL_MAX_GAIN, ((currentAvcAmMaxGain = 48) * 340));
    };

    void SI4735_setAvcAmMaxGain1(uint8_t gain); //!<  Sets the maximum gain for automatic volume control.
     ...
     */
    inline uint8_t SI4735_getCurrentAvcAmMaxGain()
    {
     ...
     */
    inline void SI4735_setAmSoftMuteMaxAttenuation(uint8_t smattn)//0
    {
     ...
     * @param smattn Maximum attenuation to apply when in soft mute.
     */
    inline void SI4735_setSsbSoftMuteMaxAttenuation(uint8_t smattn)//0
    {
     ...
     */
    inline bool SI4735_isAgcEnabled()
    {
     ...
     */
    inline uint8_t SI4735_getAgcGainIndex()
    {
    ...
    void SI4735_getCurrentReceivedSignalQuality0(void);
     ...
     */
    inline uint8_t SI4735_getCurrentRSSI()
    {
     ...
     */
    inline uint8_t SI4735_getCurrentSNR()
    {
     ...
     */
    inline bool SI4735_getCurrentRssiDetectLow()
    {
     ...
     */
    inline bool SI4735_getCurrentRssiDetectHigh()
    {
     ...
     */
    inline bool SI4735_getCurrentSnrDetectLow()
    {
     ...
     */
    inline bool SI4735_getCurrentSnrDetectHigh()
    {
     ...
     */
    inline bool SI4735_getCurrentValidChannel()
    {
     ...
     */
    inline bool SI4735_getCurrentAfcRailIndicator()
    {
     ...
     */
    inline bool SI4735_getCurrentSoftMuteIndicator()
    {
     ...
     */
    inline uint8_t SI4735_getCurrentStereoBlend()
    {
     ...
     */
    inline bool SI4735_getCurrentPilot()
    {
     ...
     * @return uint8_t value (0 to 100)
     */
    inline uint8_t SI4735_getCurrentMultipath()
    {
     ...
     * @return uint8_t
     */
    inline uint8_t SI4735_getCurrentSignedFrequencyOffset() {
     ...
     * @return false
     */
    inline bool SI4735_getCurrentMultipathDetectLow() {
     ...
     * @return false
     */
    inline bool SI4735_getCurrentMultipathDetectHigh() {
     ...
     * @return false
     */
    inline bool SI4735_getCurrentBlendDetectInterrupt() {
     ...
     * @return uint8_t
     */
    inline uint8_t SI4735_getFirmwarePN() {
     ...
     * @return uint8_t
     */
    inline uint8_t SI4735_getFirmwareFWMAJOR() {
     ...
     * @return uint8_t
     */
    inline uint8_t SI4735_getFirmwareFWMINOR() {
     ...
     * @return uint8_t
     */
    inline uint8_t SI4735_getFirmwarePATCHH() {
     ...
     * @return uint8_t
     */
    inline uint8_t SI4735_getFirmwarePATCHL() {
     ...
     * @return uint8_t
     */
    inline uint8_t SI4735_getFirmwareCMPMAJOR() {
     ...
     * @return uint8_t
     */
    inline uint8_t SI4735_getFirmwareCMPMINOR() {
     ...
     * @return uint8_t
     */
    inline uint8_t SI4735_getFirmwareCHIPREV() {
     ...
     * @return uint8_t
     */
    inline uint8_t SI4735_getCurrentVolume() { return Volume; };
     ...
     * @see volumeUp
     */
    inline void SI4735_setVolumeUp() { SI4735_volumeUp(); };
    /**
     * @ingroup group13 Audio volume
     ...
     * @return voi
     */
    inline void SI4735_setVolumeDown() { SI4735_volumeDown(); };
     ...
     */
    inline void SI4735_setAudioMode(uint8_t audioMode)
    {
     ...
     */
    inline void SI4735_setAmDelayNB(uint16_t value) {
     ...
     */
   inline void SI4735_setAMDeEmphasis(uint8_t parameter)
    {
     ...
     */
    inline void SI4735_setAMSoftMuteSlop(uint8_t parameter)
    {
     ...
     */
    inline void SI4735_setAMSoftMuteRate(uint8_t parameter)
    {
     ...
     */
    inline void SI4735_setAMSoftMuteSnrThreshold(uint8_t parameter)
    {
     ...
     */
    inline void SI4735_setAMSoftMuteReleaseRate(uint8_t parameter)
    {
     ...
     */
    inline void SI4735_setAMSoftMuteAttackRate(uint16_t parameter)
    {
     ...
     */
    inline void SI4735_setAmAgcAttackRate(uint16_t parameter)
    {
     ...
     */
    inline void SI4735_setAmAgcReleaseRate(uint16_t parameter)
    {
     ...
     * @param parameter Range: 4–248 (The default is 0x04)
     */
    inline void SI4735_setSsbAgcAttackRate(uint16_t parameter)
    {
     ...
     */
    inline void SI4735_setSsbAgcReleaseRate(uint16_t parameter)
    {
     ...
     * @param ATTN_BACKUP ???
     */
    inline void SI4735_setAMFrontEndAgcControl(uint8_t MIN_GAIN_INDEX, uint8_t ATTN_BACKUP)
    {
     ...
     */
    inline bool SI4735_isCurrentTuneFM()
    {
     ...
     */
    inline bool SI4735_isCurrentTuneAM()
    {
     ...
     */
    inline bool SI4735_isCurrentTuneSSB()
    {
     ...
     * @retrn uint8_t
     */
    inline uint8_t SI4735_getTuneFrequecyFast() {
     ...
     * @param FAST
     */
    inline void SI4735_setTuneFrequencyFast (uint8_t FAST) {
     ...
     * @return unt8_t
     */
    inline uint8_t SI4735_getTuneFrequecyFreeze() {
     ...
     * @param FREEZE
     */
    inline void SI4735_setTuneFrequencyFreze(uint8_t FREEZE) {
     ...
     * @see frequencyUp
     */
    inline void SI4735_setFrequencyUp() { SI4735_frequencyUp(); };
     ...
     * @see frequencyDown
     */
    inline void SI4735_setFrequencyDown() { SI4735_frequencyDown(); };
     ...
     */
    inline void SI4735_setMaxSeekTime(long time_in_ms)
    {
    ...
    */
    inline void SI4735_seekStationUp()
    {
    	SI4735_seekStationProgress0(NULL, SEEK_UP);
    };
    ...
    * @see Si47XX PROGRAMMING GUIDE; AN332 (REV 1.0); pages 124, 137, 139, 278
    */
    inline void SI4735_seekStationDown()
    {
    ...
    void SI4735_getRdsStatus1(uint8_t INTACK, uint8_t MTFIFO, uint8_t STATUSONLY);
    void SI4735_getRdsStatus0();
     ...
     */
    inline bool SI4735_getRdsReceived()
    {
     ...
     * @return true or false
     */
    inline bool SI4735_getGroupLost()
    {
    ...
    void SI4735_setNBFM1(uint16_t fromFreq, uint16_t toFreq, uint16_t initialFreq, uint16_t step);
     ...
     */
    inline void SI4735_setMaxDelayPowerUp(uint16_t ms)
    {
     ...
     * @param ms
     */
    inline void SI4735_setMaxDelaySetFrequency(uint16_t ms)
    {
     ...
     */
    inline void SI4735_setFrequencyStep(uint16_t step)
    {
        currentStep = step;
    }
     ...
     * @see getFrequency()
     */
    inline uint16_t SI4735_getCurrentFrequency()
    {
     ...
     */
    inline void SI4735_setI2CLowSpeedMode(void)
    {
        //Wire.setClock(10000);
    };
     ...
     */
    inline void SI4735_setI2CStandardMode(void)
    {
     ...
     */
    inline void SI4735_setI2CFastMode(void)
    {
     ...
     */
    inline void SI4735_setI2CFastModeCustom(long value)
    {
    	//long value = 500000;
    	//Wire.setClock(value);
    };
     ...
     */
    inline void SI4735_setAudioMuteMcuPin(int8_t pin)
    {
        //audioMuteMcuPin = pin;
     ...
     */
    inline void SI4735_setHardwareAudioMute(bool on)
    {
